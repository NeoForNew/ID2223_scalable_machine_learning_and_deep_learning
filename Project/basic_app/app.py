...
demo = gr.Interface(
    ...
    inputs=[
        ...
        gr.inputs.Number(default=0.0, label="clear_day"),
        gr.inputs.Number(default=0.0, label="clear_night"),
        gr.inputs.Number(default=0.0, label="cloudy"),
        gr.inputs.Number(default=0.0, label="fog"),
        gr.inputs.Number(default=0.0, label="partly_cloudy_day"),
        gr.inputs.Number(default=0.0, label="partly_cloudy_night"),
        gr.inputs.Number(default=0.0, label="rain1"),
        gr.inputs.Number(default=0.0, label="snow1"),
        gr.inputs.Number(default=0.0, label="wind"),
        gr.inputs.Number(default=0.0, label="Clear"),
        gr.inputs.Number(default=0.0, label="Overcast"),
        gr.inputs.Number(default=0.0, label="Partially_cloudy"),
        gr.inputs.Number(default=0.0, label="Rain"),
        gr.inputs.Number(default=0.0, label="Rain_Overcast"),
        gr.inputs.Number(default=0.0, label="Rain_Partially_cloudy"),
        gr.inputs.Number(default=0.0, label="Snow"),
        gr.inputs.Number(default=0.0, label="Snow_Overcast"),
        gr.inputs.Number(default=0.0, label="Snow_Partially_cloudy"),
        gr.inputs.Number(default=0.0, label="Snow_Rain"),
        gr.inputs.Number(default=0.0, label="Snow_Rain_Overcast"),
    ],
    outputs=gr.Textbox()
    )
